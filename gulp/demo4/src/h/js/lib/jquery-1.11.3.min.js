!(function (e, t) {
  ...
  function C(e, t) {
    ...
    if (1 === t.nodeType) {
      if (((n = t.nodeName.toLowerCase()), !ne.noCloneEvent && t[ie.expando])) {
        for (r in ((i = ie._data(t)), i.events)) ie.removeEvent(t, r, i.handle)
  ...
  function F(e, t, n) {
    ...
    if (ie.isEmptyObject(f))
      ...
      d.done(function () {
        var t
        for (t in (ie._removeData(e, 'fxshow'), f)) ie.style(e, t, f[t])
      }),
      f))
        (a = M(h ? m[r] : 0, r, d)),
          r in m ||
    ...
    ie.extend({
      ...
      each: function (e, t, r) {
        var i,
          ...
          s = n(e)
        if (r) {
          if (s) for (; a > o && ((i = t.apply(e[o], r)), !1 !== i); o++);
      ...
      (S = t.select = function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === d.length)) {
          if (
            ...
            if (
              ((t = (T.find.ID(a.matches[0].replace(we, Te), t) || [])[0]), !t)
            )
              return n
  ...
  ;(ie.Callbacks = function (e) {
    ...
    (ie.ready.promise = function (t) {
      if (!be)
        if (((be = ie.Deferred()), 'complete' === he.readyState))
          setTimeout(ie.ready)
      ...
      (ie.event.special.submit = {
        setup: function () {
          return (
            ...
            void ie.event.add(this, 'click._submit keypress._submit', function (
              e
            ) {
              var t = e.target,
                n =
          ...
          ;(n = he.getElementsByTagName('body')[0]),
            n &&
              ...
              e.getComputedStyle &&
                ...
                (l = t.appendChild(he.createElement('div'))),
        ...
        : this.each(
            ie.isFunction(e)
              ...
              : function () {
                  if ('string' === n)
                    for (
                      var t, r = 0, i = ie(this), o = e.match(xe) || [];
                      (t = o[r++]);
  ...
  ;(ie.offset = {
    ...
    ie.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (
      e,
      t
    ) {
      var n = /Y/.test(t)
    ...
    ie.each({ Height: 'height', Width: 'width' }, function (e, t) {
      ie.each({ padding: 'inner' + e, content: t, '': 'outer' + e }, function (
        n,
        r
      ) {
  ...
  return (
    (ie.noConflict = function (t) {
      return (
        e.$ === ie && (e.$ = on), t && e.jQuery === ie && (e.jQuery = rn), ie
      )
    }),
